...
import com.fys.spark.rpc.io.{ByteBufferInputStream, ByteBufferOutputStream}
...
class JavaSerializer(conf: RpcConf) extends Serializer with Externalizable {
  ...
  override def newInstance(): SerializerInstance = {
    ...
    val streamFactory: SerializationStreamFactory = classLoader
      .loadClass(conf.get("spark.rpc.serialization.stream.factory", "com.fys.spark.rpc.serializer.JavaSerializationStreamFactory"))
